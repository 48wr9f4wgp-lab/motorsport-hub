...
const foot=w.addText('※ 現行moduleと同じ一次データ依存を通信/identityまで診断。Small/Medium実機QAは別途必要。');foot.font=Font.systemFont(7.1);foot.textColor=new Color(C.muted);foot.lineLimit=1;w.refreshAfterDate=new Date(Date.now()+10*60000);
