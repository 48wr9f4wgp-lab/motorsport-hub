...
assert(sourceById.WRC.includes('fia.com/events/world-rally-championship/season-2026/standings'));for(const token of ['Rally Italia Sardegna','2026-10-01T09:00:00+02:00','hold=4*86400000','2026 FIA World Rally Championship for Drivers'])assert(sourceById.WRC.includes(token));assert(!sourceById.WRC.includes('Rally Saudi Arabia'),'cancelled 2026 WRC Saudi round must not return');
assert(sourceById.SUPERGT.includes('supergt.net/driver_ranking?gt_class=gt500&series=2026'));for(const token of ["'8':{name:'太田 格之進 / 大津 弘樹'","'12':{name:'平峰 一貴 / ベルトラン・バゲット'","'14':{name:'福住 仁嶺 / 大嶋 和也'","'16':{name:'野尻 智紀 / 佐藤 蓮'","'17':{name:'塚越 広大 / 野村 勇斗'","'19':{name:'国本 雄資 / 阪口 晴南'","'23':{name:'千代 勝正 / 高星 明誠'","'24':{name:'名取 鉄平 / 三宅 淳詞'","'36':{name:'坪井 翔 / 山下 健太'","'37':{name:'笹原 右京 / ジュリアーノ・アレジ'","'38':{name:'大湯 都史樹 / 小林 利徠斗'","'39':{name:'関口 雄飛 / サッシャ・フェネストラズ'","'64':{name:'大草 りき / イゴール・オオムラ・フラガ'","'100':{name:'山本 尚貴 / 牧野 任祐'",'第8戦 MOTEGI','hold=8*3600000'])assert(sourceById.SUPERGT.includes(token));assert(sourceById.SUPERGT.includes('MOTUL%20AUTECH%20Z%202024%20rd.2%20FUJI.jpg'));assert(!sourceById.SUPERGT.includes('Osaka%20Auto%20Messe%202025'));
