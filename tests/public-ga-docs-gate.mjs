...
for(const p of ['README.md','INSTALL.md','SUPPORT.md','PRIVACY.md','GA_READINESS.md','CHANGELOG.md','.github/ISSUE_TEMPLATE/bug_report.yml']){
...
for(const p of ['INSTALL.md','SUPPORT.md','PRIVACY.md','GA_READINESS.md'])assert(readme.includes(p),`README must link ${p}`);
