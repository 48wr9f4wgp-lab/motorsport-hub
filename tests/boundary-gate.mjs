...
const NASCAR=[
 ...
 {name:'Gateway',start:'2026-09-13T15:00:00-04:00',end:'2026-09-13T21:00:00-04:00'},
];
assert.equal(pickRange(NASCAR,parse('2026-08-29T18:00:00-04:00')),'Daytona','NASCAR: select upcoming Daytona');
