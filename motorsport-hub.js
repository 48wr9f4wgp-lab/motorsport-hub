// Motorsport Hub v8.6.0 — module router
// F1 / WRC / MotoGP remain on frozen v8.4.1 core. WEC / SUPER GT use dedicated HQ module. FDJ remains isolated.
(async()=>{
...
else if(isHQ){file='motorsport-hq-core.js';key='hq-v860'}
...
let code='';
try{
  const r=new Request(`${URL}?v=860&t=${Date.now()}-${Math.random()}`);r.timeoutInterval=12;
