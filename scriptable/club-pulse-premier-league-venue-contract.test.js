...
check('venue registry season is 2026-27',context.CP_PL_VENUE_REGISTRY_SEASON==='2026-27');
check('Premier League registry has exactly 20 current clubs',Object.keys(context.CP_PL_2026_27_HOME_VENUES||{}).length===20);
...
check('relegated Burnley West Ham Wolves absent',['バーンリー','ウェストハム','ウルブズ'].every(k=>!Object.prototype.hasOwnProperty.call(context.CP_PL_2026_27_HOME_VENUES,k)));
