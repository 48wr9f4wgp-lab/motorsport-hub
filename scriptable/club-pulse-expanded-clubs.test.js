...
check('Dortmund remains signal yellow with dark text',has(design,"key:'dortmund',tone:'signal-yellow-black'")&&has(design,"cardText:'#111111'"));
...
console.log('\nEleven-club localization and venue fallback QA PASSED');
