...
check('launcher uses small presentation v7 local cache',src.includes('ClubPulseSmallPresentationPatch_v7.js'));
check('launcher fetch tag is small-presentation7',src.includes("'small-presentation7'"));
check('launcher pins small presentation v7 commit',src.includes('47f6d8a3eee1ff9188bfbeadb5169adc2ac0f54f/scriptable/club-pulse-small-presentation-patch.js'));
...
check('launcher documents 44-club architecture',src.includes('Club Pulse 44-club runtime')&&src.includes('Wave 4 adds RC Lens')&&src.includes('Premium Visual v4')&&src.includes('Small Presentation v7'));
