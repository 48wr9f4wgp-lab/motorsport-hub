...
check('launcher uses small presentation v8 local cache',src.includes('ClubPulseSmallPresentationPatch_v8.js'));
check('launcher fetch tag is small-presentation8',src.includes("'small-presentation8'"));
check('launcher pins small presentation v8 commit',src.includes('be9157da7032480c308744edcd4cf7a51270dcde/scriptable/club-pulse-small-presentation-patch.js'));
...
check('launcher documents 44-club architecture',src.includes('Club Pulse 44-club runtime')&&src.includes('Wave 4 adds RC Lens')&&src.includes('Premium Visual v4')&&src.includes('Small Presentation v8'));
