...
check('launcher uses small presentation v6 local cache',src.includes('ClubPulseSmallPresentationPatch_v6.js'));
check('launcher fetch tag is small-presentation6',src.includes("'small-presentation6'"));
check('launcher pins small presentation v6 commit',src.includes('264afc65f21cc2223f9d79107285e959105a9a29/scriptable/club-pulse-small-presentation-patch.js'));
...
check('launcher documents 44-club architecture',src.includes('Club Pulse 44-club runtime')&&src.includes('Wave 4 adds RC Lens')&&src.includes('Premium Visual v4')&&src.includes('Small Presentation v6'));
