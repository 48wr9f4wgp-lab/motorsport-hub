...
check('launcher uses Medium Scale Unification v1',src.includes('ClubPulseMediumScaleUnificationPatch_v1.js')&&src.includes("'medium-scale-unification1'"));
check('launcher pins Medium Scale Unification v1',src.includes('747c61104e122fd369627e43a2ebc3dd24d4f707/scriptable/club-pulse-medium-scale-unification-patch.js'));
...
check('Medium Scale Unification runs last',src.includes("+sui+'\\n'+pr+'\\n'+msu,b="));
