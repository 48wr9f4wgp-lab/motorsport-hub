...
let c=await core(),
  ...
  pv=await getRemote(PREMIUM_PATCH,PVP,900,'premium6'),rg=await getRemote(READABILITY_PATCH,RGP,2200,'readability8'),cm=await getRemote(CACHE_MIGRATION_PATCH,CMP,700,'cache-migration1'),
