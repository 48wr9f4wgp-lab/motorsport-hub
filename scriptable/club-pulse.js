...
const DATA_POLICY_PATCH='https://raw.githubusercontent.com/48wr9f4wgp-lab/motorsport-hub/d872cbf369b0dde43e2227d0fa91ec21b6977890/scriptable/club-pulse-data-policy-patch.js';
const SMALL_PRESENTATION_PATCH='https://raw.githubusercontent.com/48wr9f4wgp-lab/motorsport-hub/2e117cf2fb9f05796dd36028769247a6ed7bfc0b/scriptable/club-pulse-small-presentation-patch.js';
...
let c=await core(),
  ...
  dp=await getRemote(DATA_POLICY_PATCH,DPP,3200,'data-policy7'),sp=await getRemote(SMALL_PRESENTATION_PATCH,SPP,2600,'small-presentation9'),
...
/* Club Pulse 44-club runtime. Existing forty-three visuals stay frozen. Wave 4 adds RC Lens through registry/theme/localization/venue data only, with no club-specific renderer branches. Core and every patch are immutable commit-pinned and version-cached local-first. Data Policy v7 rejects impossible future FINISHED states before mapping and repairs already-cached future POST states back to neutral NEXT. Small Presentation v9 preserves full-name typography and scored-state widths while protecting the NEXT VS column from clipping. Premium Visual v4 makes generic Medium team labels honor the same cardText token.
