...
let c=await core(),
  ...
  dp=await getRemote(DATA_POLICY_PATCH,DPP,3200,'data-policy8'),sp=await getRemote(SMALL_PRESENTATION_PATCH,SPP,2600,'small-presentation9'),
