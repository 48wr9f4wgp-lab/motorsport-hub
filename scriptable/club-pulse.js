...
/* Compatibility padding: keep this launcher above 1000 bytes because older installed recovery loaders reject downloaded runtime files shorter than 1000 bytes. Club Pulse injects declarative club registry v2 before core parameter resolution. Shared theme registry v7 uses one restrained dark club-color glow per widget, flat secondary components, subtle borders, and transparent crest treatment with no circular plates. Manchester United uses near-black with a deep red glow and restrained gold; Barcelona uses deep navy with a muted garnet glow and restrained gold; Real Madrid uses deep navy/royal-blue undertones with white confined to typography/crest identity and restrained gold. The legacy Manchester United patch remains loaded only for its established match-state rendering and POST form-sync behavior. New clubs should normally be added through club registry plus shared theme tokens rather than cloned renderer files. Competition identity colors and logos remain shared across clubs. */