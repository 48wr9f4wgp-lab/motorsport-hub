...
const PREMIUM_PATCH='https://raw.githubusercontent.com/48wr9f4wgp-lab/motorsport-hub/1b5be468f91013f99c4f79ef23e885cb1ce5690c/scriptable/club-pulse-premium-visual-patch.js';
...
let c=await core(),
  ...
  pv=await getRemote(PREMIUM_PATCH,PVP,900,'premium5'),rg=await getRemote(READABILITY_PATCH,RGP,2200,'readability8'),cm=await getRemote(CACHE_MIGRATION_PATCH,CMP,700,'cache-migration1'),
