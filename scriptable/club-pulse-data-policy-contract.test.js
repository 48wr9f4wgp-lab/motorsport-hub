...
check('launcher pins data policy v5',has(launcher,'23ce824baa89c210f209e0c7336c564534933d6a')&&has(launcher,'ClubPulseDataPolicyPatch_v5.js')&&has(launcher,"'data-policy5'"));
...
check('old cache timestamp gains calendar date',has(policy,'CP_DP_OLD_CACHE_AGE=24*60*60*1000')&&has(policy,"fmt(new Date(ms),'M/d HH:mm')+'更新'"));
