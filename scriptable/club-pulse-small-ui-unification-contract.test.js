...
check('launcher pins Small UI Unification immutably',launcher.includes('d16a8e2117d377ab3b842967480f16010b4e7b72/scriptable/club-pulse-small-ui-unification-patch.js'));
check('launcher uses dedicated unification cache',launcher.includes('ClubPulseSmallUIUnificationPatch_v1.js')&&launcher.includes("'small-ui-unification1'"));
