...
check('launcher documents canonical form ownership',launcher.includes('Canonical Form System v1 owns W/D/L/unknown typography')&&launcher.includes('Previous Result v2 is loaded last'));
